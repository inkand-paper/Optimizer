...
const categories = [
  {
    ...
    description: "Core concepts, architecture overview, and quick-start guides.",
    links: [
      { label: "Core Concepts",      href: "/docs/concepts" },
      { label: "Master Guide",       href: "/docs/master"   },
      { label: "Environment Setup",  href: "/docs/master#11-environment-variables" },
      { label: "Self-Hosting",       href: "/docs/master#10-integration-pattern" },
    ],
  },
  {
    icon: Terminal,
    ...
    links: [
      ...
      { label: "Code Audit",         href: "/docs/api#post-apicode-review" },
      { label: "Webhook Events",     href: "/docs/api#webhooks-outbound" },
    ],
  },
  {
    icon: Smartphone,
    title: "Mobile & SDKs",
    description: "Connect Android and iOS apps to the NexPulse engine.",
    links: [
      { label: "Android (Kotlin)", href: "/docs/master#10-integration-pattern" },
      { label: "iOS (Swift)",      href: "/docs/master#10-integration-pattern" },
    ],
  },
  {
    icon: Activity,
    title: "Billing & Plans",
    description: "Plan limits, student trials, promotions, and LemonSqueezy integration.",
    links: [
      { label: "Plan Limits",       href: "/docs/master#4-plan-limits" },
      { label: "Student Trial",     href: "/docs/api#post-apistudentverify" },
      { label: "Promotions",        href: "/docs/api#post-apipromotions" },
      { label: "Webhook Events",    href: "/docs/master#7-billing-lemonsqueezy" },
    ],
  },
  {
    icon: GitBranch,
    title: "Security",
    description: "Authentication, SSRF protection, rate limiting, and MFA.",
    links: [
      { label: "Security Architecture", href: "/docs/master#8-security-architecture" },
      { label: "Auth System",           href: "/docs/master#2-architecture" },
      { label: "API Key Safety",        href: "/docs/master#3-database-schema-all-tables" },
  ...
  },
  {
    icon: Mail,
    title: "Contributing",
    description: "Dev setup, code style rules, PR checklist, and AI agent directives.",
    links: [
