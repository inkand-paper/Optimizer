...
```powershell
Invoke-RestMethod -Uri "https://nexpulse-optimizer.vercel.app/api/health" -Method Get
```
...
```powershell
try {
    Invoke-RestMethod -Uri "https://nexpulse-optimizer.vercel.app/api/revalidate" -Method Post -Body '{"tag": "test"}' -Headers @{"Content-Type"="application/json"}
} catch {
...
$loginResponse = Invoke-RestMethod -Uri "https://nexpulse-optimizer.vercel.app/api/auth/login" -Method Post -Headers @{"Content-Type"="application/json"} -Body $loginBody
...
$keyResponse = Invoke-RestMethod -Uri "https://nexpulse-optimizer.vercel.app/api/keys" -Method Post -Headers @{
...
$revalResponse = Invoke-RestMethod -Uri "https://nexpulse-optimizer.vercel.app/api/revalidate" -Method Post -Headers @{
    "Content-Type" = "application/json"
...
$analyzeResponse = Invoke-RestMethod -Uri "https://nexpulse-optimizer.vercel.app/api/analyze" -Method Post -Headers @{
    "Content-Type" = "application/json"
    "Authorization" = "Bearer $apiKey"
} -Body $analyzeBody
